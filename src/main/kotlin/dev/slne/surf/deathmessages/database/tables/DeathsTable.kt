...
object DeathsTable : LongIdTable("death_deaths") {
    val deathId = nativeUuid("death_uuid").uniqueIndex()
    val playerId = nativeUuid("player_uuid")

    val worldId = nativeUuid("world_uuid")
    val x = double("x")
    val y = double("y")
    val z = double("z")
    ...
    val isKeepInventory = bool("isKeepInventory")
